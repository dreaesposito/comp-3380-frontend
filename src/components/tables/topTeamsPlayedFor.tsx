...
export const columns = [
  ...
  {
    name: "Teams Played For",
    uid: "num_teams",
  },
];

const INITIAL_VISIBLE_COLUMNS = ["rank", "first_name", "num_teams"];
...
export default function TopTeamsPlayedFor({ numRows }: Props) {
  ...
  useEffect(() => {
    const getPlayers = async () => {
      const { data, error } = await supabase.rpc("top_teams_played_for", {
        num_rows: numRows,
      });
